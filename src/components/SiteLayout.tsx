...
const navItems = [
  ...
  { href: "/historie", label: "Historie", key: "historie" },
  { href: "/biergarten", label: "Biergarten", key: "biergarten" },
...
export function Header({
  ...
  return (
    <header>
      <Link to="/">
        <div className="logo">
          <img src="/assets/images_converted/transparent/logo_neu.png" alt="Hellensteiner Logo" />
        </div>
      </Link>
  ...
  return (
    <footer>
      <div className="footer-grid">
        ...
        <div>
          <h3>Folge uns:</h3>
          <a href="https://www.instagram.com/hellensteiner_brauerei/" className="sozial-link" aria-label="Instagram">
          ...
          <a href="https://www.facebook.com/share/17VXGpS5KQ/" className="sozial-link" aria-label="Facebook">
          ...
          <a href="https://www.youtube.com/@HellensteinerBr%C3%A4u" className="sozial-link" aria-label="YouTube">
            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="var(--color-primary)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" focusable="false">
